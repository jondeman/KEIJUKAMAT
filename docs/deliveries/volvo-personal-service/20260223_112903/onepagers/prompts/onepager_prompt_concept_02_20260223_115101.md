...
- TOP RIGHT CORNER: Small, elegant Volvo Personal Service company logo
...
Jos et löydä tarkkaa logoa tai brändivärejä, käytä Volvo Personal Servicen virallista logoa sekä logoon ja brändi-ilmeeseen sopivia värisävyjä.

## HEADER SECTION (top 18%)
Below the logos:
- LARGE BOLD TITLE: "Konepellin Alla"
- Subtitle: "Volvo Personal Servicen Omamekaanikot astuvat kameran eteen ja paljastavat ne autohuollon totuude..."
...
- **MITÄ?** Volvo Personal Servicen Omamekaanikot astuvat kameran eteen ja paljastavat ne autohuollon totuudet, jotka jokaisen autoilijan pitäisi tietää — mutta joita ku...
- **MITEN?** **Pääformaatti:** - **30–75 sekunnin TikTok-videot**, pystyformaatti, julkaistaan Volvo Car Finlandin TikTok-tilillä - Rakenne per jakso: **Hook (0–3 s)** →...
- **MIKSI?** Tekee Volvo Personal Servicesta puheenaiheen ja muuttaa kiinnostuksen toiminnaksi.
...
Volvo Personal Servicen Omamekaanikot astuvat kameran eteen ja paljastavat ne autohuollon totuudet, jotka jokaisen autoilijan pitäisi tietää — mutta joita kukaan ei ole kertonut heille suoraan. **Konepellin Alla** on TikTok-first genAI-avusteinen lyhytvideosarja, jossa aito mekaanikon ääni ja asiantuntemus yhdistyy visuaalisesti hätkähdyttäviin genAI-toteutettuihin "röntgenkuviin" siitä, mitä auton sisällä todella tapahtuu. Jokainen jakso alkaa provokatiivisella väitteellä — "80 % suomalaisista ...
...
**Pääformaatti:**
- **30–75 sekunnin TikTok-videot**, pystyformaatti, julkaistaan Volvo Car Finlandin TikTok-tilillä
- Rakenne per jakso: **Hook (0–3 s)** → **Myytti/väite (3–10 s)** → **GenAI-visualisointi: mitä oikeasti tapahtuu (10–40 s)** → **Omamekaanikon Pro Tip (40–60 s)** → **CTA/osallistumiskysymys (60–75 s)**
- GenAI-toteutus: animoidut "röntgenkuvat" ja poikkileikkauskuvat autonosista (ei oikeaa autoa leikata auki, vaan genAI mahdollistaa visuaalisen tarinankerronnan, joka olisi muuten mahdotonta tai kohtuuttoman kallista)

**Julkaisurytmi ja kaari:**
- **Kausi 1: 12 jaksoa / 6 viikkoa** (2 jaksoa viikossa, tiistai + perjantai)
- Temaattinen kaari seuraa vuodenaikoja ja autoilun arkea: talvikausi → kevätvalmistelu → kesämatkailu
- Joka neljäs jakso on **"Mekaanikon vastaa" -special**, jossa Omamekaanikko vastaa seuraajien kommenteissa esitettyihin kysymyksiin (yhteisövetoinen sisältö)

**Laajennukset:**
- **IG Reels:** Sama sisältö optimoituna Instagramin algoritmille (tekstit päällä, hitaampi leikkaus)
- **YouTube Shorts:** Pidempi versio (90 s) lisäsyvennyksineen hakunäkyvyyden maksimoimiseksi ("miten vaihdetaan pyyhkijänsulat Volvo" -tyyppiset haut)
- **Volvo Cars App:** Jaksojen parhaat vinkit integroidaan appiin push-ilmoituksina ennen huoltokautta ("Talvi tulossa — katso 3 asiaa, jotka Omamekaanikkosi toivoisi sinun tekevän")
- **Jälleenmyyjien odotustilat:** Jaksojen kooste pyörii screenillä odotustiloissa — asiakas näkee saman sisällön, joka oli somessa, mikä vahvistaa tunnistettavuutta
- **PR:** Lanseeraukseen liitetään "Suomalaisten autoilutietämystesti" — kyselytutkimus, joka tuottaa median otsikoita ("Joka kolmas suomalainen ei tiedä, milloin jarrupalat pitää vaihtaa")
...
## FOOTER
"Konsepti joka tekee Volvo Personal Servicesta puheenaiheen ja tavoittaa uusia yleisöjä."
A compelling summary of why this concept is perfect for this brand.

## COLOR PALETTE
- Primary brand color: #8080a0
- Secondary color: #6080a0
- Accent color: #8d99b9
