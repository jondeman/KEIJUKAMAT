...
- TOP RIGHT CORNER: Small, elegant Stockmann company logo
...
Jos et löydä tarkkaa logoa tai brändivärejä, käytä Stockmannn virallista logoa sekä logoon ja brändi-ilmeeseen sopivia värisävyjä.

## HEADER SECTION (top 18%)
Below the logos:
- LARGE BOLD TITLE: "STOCKMANNIN VARJOSTYLISTIT"
- Subtitle: "Stockmannin lattioilla työskentelee ihmisiä, jotka tietävät muodista, kosmetiikasta ja kodista en..."
...
- **MITÄ?** Stockmannin lattioilla työskentelee ihmisiä, jotka tietävät muodista, kosmetiikasta ja kodista enemmän kuin yksikään algoritmi – mutta kukaan ei tiedä heidän...
- **MITEN?** Monikanavainen toteutus, selkeä rakenne ja osallistava aktivointi.
- **MIKSI?** Tekee Stockmannsta puheenaiheen ja muuttaa kiinnostuksen toiminnaksi.
...
Stockmannin lattioilla työskentelee ihmisiä, jotka tietävät muodista, kosmetiikasta ja kodista enemmän kuin yksikään algoritmi – mutta kukaan ei tiedä heidän nimiään. **Varjostylistit** on TikTok-first-sarja, jossa Stockmannin omat asiantuntijat – kosmetiikkatiskin veteraani, miesten pukeutumisen guru, kodin osaston legenda – astuvat kameroiden eteen ja haastavat somevaikuttajia, trendejä ja yleisön ennakkoluuloja. Formaatti on nopea, jännitteinen ja osallistava: jokaisessa jaksossa asiantuntija...
...
## FOOTER
"Konsepti joka tekee Stockmannsta puheenaiheen ja tavoittaa uusia yleisöjä."
A compelling summary of why this concept is perfect for this brand.

## COLOR PALETTE
- Primary brand color: #00a37c
- Secondary color: #004030
- Accent color: #bfe8de
