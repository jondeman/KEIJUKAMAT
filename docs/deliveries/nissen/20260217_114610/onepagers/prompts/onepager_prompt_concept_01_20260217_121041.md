...
- TOP RIGHT CORNER: Small, elegant Nissen company logo
...
Jos et löydä tarkkaa logoa tai brändivärejä, käytä Nissenn virallista logoa sekä logoon ja brändi-ilmeeseen sopivia värisävyjä.

## HEADER SECTION (top 18%)
Below the logos:
- LARGE BOLD TITLE: "NÄYTÄ MUN NAAMALLA"
- Subtitle: "Silmälasit ovat ainoa asuste, jota kannetaan keskellä naamaa joka päivä – ja silti useimmat valit..."
...
- **MITÄ?** Silmälasit ovat ainoa asuste, jota kannetaan keskellä naamaa joka päivä – ja silti useimmat valitsevat ne paniikissa viidessä minuutissa optikkoliikkeessä. *...
- **MITEN?** Monikanavainen toteutus, selkeä rakenne ja osallistava aktivointi.
- **MIKSI?** Tekee Nissensta puheenaiheen ja muuttaa kiinnostuksen toiminnaksi.
...
## FOOTER
"Konsepti joka tekee Nissensta puheenaiheen ja tavoittaa uusia yleisöjä."
A compelling summary of why this concept is perfect for this brand.

## COLOR PALETTE
- Primary brand color: #0073ec
- Secondary color: #005ab9
- Accent color: #0067d3
