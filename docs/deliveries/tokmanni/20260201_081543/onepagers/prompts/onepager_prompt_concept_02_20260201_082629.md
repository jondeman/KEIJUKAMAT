...
- TOP RIGHT CORNER: Small, elegant Tokmanni company logo
...
Jos et löydä tarkkaa logoa tai brändivärejä, käytä Tokmannin virallista logoa sekä logoon ja brändi-ilmeeseen sopivia värisävyjä.

## HEADER SECTION (top 18%)
Below the logos:
- LARGE BOLD TITLE: "Tokmannin Löytöreissu"
- Subtitle: "Tokmannin Löytöreissu on TikTok-natiivi sarjaformaatti, jossa luojat ja tavalliset suomalaiset sa..."
...
- **MITÄ?** Tokmannin Löytöreissu on TikTok-natiivi sarjaformaatti, jossa luojat ja tavalliset suomalaiset saavat budjetin ja haasteen: ratkaista jokin arjen ongelma tai...
- **MITEN?** **Pääformaatti:**   - 2–3 minuutin TikTok-jaksot (viikottain) - Rakenne: Haaste → Myymäläetsintä → Yllätykset → Toteutus → Lopputulos + hintalappu - Jakso ku...
- **MIKSI?** Tekee Tokmannista puheenaiheen ja muuttaa kiinnostuksen toiminnaksi.
...
Tokmannin Löytöreissu on TikTok-natiivi sarjaformaatti, jossa luojat ja tavalliset suomalaiset saavat budjetin ja haasteen: ratkaista jokin arjen ongelma tai toteuttaa projekti pelkästään Tokmannin valikoimalla – mutta ilman etukäteistietoa siitä, mitä myymälästä löytyy. Jokainen jakso on dokumentoitu löytöretki, jossa kamera seuraa aitoa etsintää käytävien välissä, yllättäviä oivalluksia ja lopullista toteutusta. Formaatti kääntyy Tokmannin piilossa olevan valikoiman laajuuden todisteeksi: kats...
...
**Pääformaatti:**  
- 2–3 minuutin TikTok-jaksot (viikottain)
- Rakenne: Haaste → Myymäläetsintä → Yllätykset → Toteutus → Lopputulos + hintalappu
- Jakso kuvataan yhdessä myymälässä, yhden päivän aikana

**Julkaisurytmi:**  
- Ensimmäinen kausi: 8 jaksoa, 8 viikkoa
- Julkaisu: TikTok primääri (tiistai 18:00), IG Reels ja Shorts seuraavana päivänä
- Kauden lopussa: "Katsojien löytöreissut" -erikoisjakso (UGC-kooste)

**Laajennukset:**  
- **Shorts-leikkaukset:** 30 sekunnin "paras löytö" -nostot jokaisesta jaksosta
- **Myymäläaktivointit:** "Löytöreissu-kartta" tietyissä myymälöissä (QR-koodi → haaste)
- **Tokmanni Klubi:** Eksklusiiviset "salaiset haasteet" klubin jäsenille ennen julkista julkaisua
...
## FOOTER
"Konsepti joka tekee Tokmannista puheenaiheen ja tavoittaa uusia yleisöjä."
A compelling summary of why this concept is perfect for this brand.

## COLOR PALETTE
- Primary brand color: #4b4b4b
- Secondary color: #f98b25
- Accent color: #ff0000
