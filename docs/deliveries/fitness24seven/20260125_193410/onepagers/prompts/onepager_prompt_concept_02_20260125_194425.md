...
Below the logos:
- LARGE BOLD TITLE: "Salitunnustukset"
- Subtitle: "Anonyymi tunnustusformaatti, jossa tavalliset salilla kävijät kertovat häpeällisimmät, noloimmät ..."
...
- **MITÄ?** Anonyymi tunnustusformaatti, jossa tavalliset salilla kävijät kertovat häpeällisimmät, noloimmät ja rehellisimmät ajatuksensa treenaamisesta – äänitettyinä "...
- **MITEN?** **Pääformaatti:** 30–60 sekunnin pystyvideoita, joissa yksi tunnustus kerrallaan. Visuaalinen tyyli: hämärä valaistus, lähikuva kasvoista (tai siluetista ano...
...
Anonyymi tunnustusformaatti, jossa tavalliset salilla kävijät kertovat häpeällisimmät, noloimmät ja rehellisimmät ajatuksensa treenaamisesta – äänitettyinä "tunnustuskopissa" Fitness24Seven-salien pukuhuoneissa. Sisältö on raakaa, editoimatonta ja tunnistettavaa: "En tiedä miten tota laitetta käytetään, joten teen vaan hauiskääntöjä." "Käyn salilla jotta saan syödä pizzaa ilman syyllisyyttä." "Valitsen aina sen salin missä on vähiten ihmisiä." Formaatti kääntää kuntosalikulttuurin kiiltokuvan pä...
...
**Pääformaatti:** 30–60 sekunnin pystyvideoita, joissa yksi tunnustus kerrallaan. Visuaalinen tyyli: hämärä valaistus, lähikuva kasvoista (tai siluetista anonymiteetin säilyttämiseksi), tekstitys tunnustuksesta, minimalistinen äänimaailma.

**Julkaisurytmi:** 3–4 videota viikossa ensimmäiset 8 viikkoa, sitten 2 viikossa. Sarjamuotoisuus: teemaviikot kuten "Aloittelijoiden viikko", "Yölintujen tunnustukset", "Ryhmäliikunnan totuudet".

**Laajennukset:**
- **Duet-haaste:** "Tunnusta sinäkin" – katsojat tekevät omia versioitaan
- **Salikohtaiset näytöt:** Parhaat tunnustukset pyörivät salien sisäänkäyntinäytöillä
- **PR:** "Suomen rehellisimmät salilla kävijät" -kulma medialle
- **Compilations:** Viikoittaiset koosteet YouTubeen ja pidempään katseluun
